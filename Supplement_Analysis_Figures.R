...
#Run lines 1-853 in "MainText_Analysis_Figures.R" before running this script
...
#Supplementary Figure 2 (10x9 inches)
...
#Supplementary Figure 4 (8x8 inches)
...
#Supplementary Figure 5 (8x8 inches)
...
ranef(Am.Nm.all.lmer13c)
#slope and intercept for species
...
#Supplementary Figure 6 (10x9 inches)
...
#Supplementary Figure 7 (11x5 inches)
...
#Reanalysis of Adams et al. 2016 PNAS
...
#7x12 inches
nf<-layout(matrix(c(1,2,3,4),2,1,byrow=T),c(3,3),c(3,3),T)
layout.show(nf)
par(oma=c(2,0,2,0))
par(mar=c(4,5,1,0))
par(pty="s")
...
Na.LMA.slope.non<-summary(Na.LMA.all.lmer14a.a1)$coefficients[2,1]
Na.LMA.slope.fix<-summary(Na.LMA.all.lmer14a.a1)$coefficients[2,1]+summary(Na.LMA.all.lmer14a.a1)$coefficients[5,1]
Na.LMA.int.fix<-summary(Na.LMA.all.lmer14a.a1)$coefficients[1,1]+summary(Na.LMA.all.lmer14a.a1)$coefficients[3,1]
Na.LMA.int.non<-summary(Na.LMA.all.lmer14a.a1)$coefficients[1,1]
Na.LMA.int.non.NLIM<-summary(Na.LMA.all.lmer14a.a1)$coefficients[1,1]+summary(Na.LMA.all.lmer14a.a1)$coefficients[4,1]
...
Nm.LMA.slope.non<-summary(Nm.LMA.all.lmer14a.a1)$coefficients[2,1]
Nm.LMA.slope.fix<-summary(Nm.LMA.all.lmer14a.a1)$coefficients[2,1]+summary(Nm.LMA.all.lmer14a.a1)$coefficients[5,1]
Nm.LMA.int.fix<-summary(Nm.LMA.all.lmer14a.a1)$coefficients[1,1]+summary(Nm.LMA.all.lmer14a.a1)$coefficients[3,1]
Nm.LMA.int.non<-summary(Nm.LMA.all.lmer14a.a1)$coefficients[1,1]
Nm.LMA.int.non.NLIM<-summary(Nm.LMA.all.lmer14a.a1)$coefficients[1,1]+summary(Nm.LMA.all.lmer14a.a1)$coefficients[4,1]
...
segments(log10(min(BENI.NSAT$LMA)),c(Na.LMA.slope.non*log10(min(BENI.NSAT$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[3,1]),
         log10(max(BENI.NSAT$LMA)),c(Na.LMA.slope.non*log10(max(BENI.NSAT$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[3,1]),
         col="green3",lty=2)
segments(log10(min(BENI.NLIM$LMA)),c(Na.LMA.slope.non*log10(min(BENI.NLIM$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[3,1]+coef(Na.LMA.all.lmer14a.a1)$Species[3,4]),
         log10(max(BENI.NLIM$LMA)),c(Na.LMA.slope.non*log10(max(BENI.NLIM$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[3,1]+coef(Na.LMA.all.lmer14a.a1)$Species[3,4]),
         col="green3",lty=4)
segments(log10(min(DOVI$LMA)),c(Na.LMA.slope.non*log10(min(DOVI$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[5,1]),
         log10(max(DOVI$LMA)),c(Na.LMA.slope.non*log10(max(DOVI$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[5,1]),
         col="darkgoldenrod1",lty=2)
segments(log10(min(na.omit(PSCA$LMA))),c(Na.LMA.slope.non*log10(min(na.omit(PSCA$LMA)))+coef(Na.LMA.all.lmer14a.a1)$Species[8,1]),
         log10(max(na.omit(PSCA$LMA))),c(Na.LMA.slope.non*log10(max(na.omit(PSCA$LMA)))+coef(Na.LMA.all.lmer14a.a1)$Species[8,1]),
         col="darkgreen",lty=2)
segments(log10(min(PSME$LMA)),c(Na.LMA.slope.non*log10(min(PSME$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[9,1]),
         log10(max(PSME$LMA)),c(Na.LMA.slope.non*log10(max(PSME$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[9,1]),
         col="cornflowerblue",lty=2)
segments(log10(min(ACKO$LMA)),c((Na.LMA.slope.non+coef(Na.LMA.all.lmer14a.a1)$Species[1,5])*log10(min(ACKO$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[1,1]+coef(Na.LMA.all.lmer14a.a1)$Species[1,3]),
         log10(max(ACKO$LMA)),c((Na.LMA.slope.non+coef(Na.LMA.all.lmer14a.a1)$Species[1,5])*log10(max(ACKO$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[1,1]+coef(Na.LMA.all.lmer14a.a1)$Species[1,3]),
         col="green3",lty=1)
segments(log10(min(ALRU$LMA)),c((Na.LMA.slope.non+coef(Na.LMA.all.lmer14a.a1)$Species[2,5])*log10(min(ALRU$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[2,1]+coef(Na.LMA.all.lmer14a.a1)$Species[2,3]),
         log10(max(ALRU$LMA)),c((Na.LMA.slope.non+coef(Na.LMA.all.lmer14a.a1)$Species[2,5])*log10(max(ALRU$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[2,1]+coef(Na.LMA.all.lmer14a.a1)$Species[2,3]),
         col="cyan",lty=1)
segments(log10(min(CAEQ$LMA)),c(Na.LMA.slope.fix*log10(min(CAEQ$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[4,1]+coef(Na.LMA.all.lmer14a.a1)$Species[4,3]),
         log10(max(CAEQ$LMA)),c(Na.LMA.slope.fix*log10(max(CAEQ$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[4,1]+coef(Na.LMA.all.lmer14a.a1)$Species[4,3]),
         col="darkorchid1",lty=1)
segments(log10(min(GLSE$LMA)),c(Na.LMA.slope.fix*log10(min(GLSE$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[6,1]+coef(Na.LMA.all.lmer14a.a1)$Species[6,3]),
         log10(max(GLSE$LMA)),c(Na.LMA.slope.fix*log10(max(GLSE$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[6,1]+coef(Na.LMA.all.lmer14a.a1)$Species[6,3]),
         col="darkgreen",lty=1)
segments(log10(min(MOFA$LMA)),c(Na.LMA.slope.fix*log10(min(MOFA$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[7,1]+coef(Na.LMA.all.lmer14a.a1)$Species[7,3]),
         log10(max(MOFA$LMA)),c(Na.LMA.slope.fix*log10(max(MOFA$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[7,1]+coef(Na.LMA.all.lmer14a.a1)$Species[7,3]),
         col="darkgoldenrod1",lty=1)
segments(log10(min(ROPS$LMA)),c(Na.LMA.slope.fix*log10(min(ROPS$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[10,1]+coef(Na.LMA.all.lmer14a.a1)$Species[10,3]),
         log10(max(ROPS$LMA)),c(Na.LMA.slope.fix*log10(max(ROPS$LMA))+coef(Na.LMA.all.lmer14a.a1)$Species[10,1]+coef(Na.LMA.all.lmer14a.a1)$Species[10,3]),
         col="cornflowerblue",lty=1)
...
segments(log10(min(na.omit(BENI.NLIM$LMA))),c(Na.LMA.slope.non*log10(min(na.omit(BENI.NLIM$LMA)))+Na.LMA.int.non.NLIM),
         log10(max(na.omit(BENI.NLIM$LMA))),c(Na.LMA.slope.non*log10(max(na.omit(BENI.NLIM$LMA)))+Na.LMA.int.non.NLIM),lwd=3,lty=4,col="black")
mtext(text="a",side=3,cex=1,adj=0)
...
segments(log10(min(BENI.NSAT$LMA)),c(Nm.LMA.slope.non*log10(min(BENI.NSAT$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[3,1]),
         log10(max(BENI.NSAT$LMA)),c(Nm.LMA.slope.non*log10(max(BENI.NSAT$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[3,1]),
         col="green3",lty=2)
segments(log10(min(BENI.NLIM$LMA)),c(Nm.LMA.slope.non.NLIM*log10(min(BENI.NLIM$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[3,1]+coef(Nm.LMA.all.lmer14a.a1)$Species[3,4]),
         log10(max(BENI.NLIM$LMA)),c(Nm.LMA.slope.non.NLIM*log10(max(BENI.NLIM$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[3,1]+coef(Nm.LMA.all.lmer14a.a1)$Species[3,4]),
         col="green3",lty=4)
segments(log10(min(DOVI$LMA)),c(Nm.LMA.slope.non*log10(min(DOVI$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[5,1]),
         log10(max(DOVI$LMA)),c(Nm.LMA.slope.non*log10(max(DOVI$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[5,1]),
         col="darkgoldenrod1",lty=2)
segments(log10(min(na.omit(PSCA$LMA))),c(Nm.LMA.slope.non*log10(min(na.omit(PSCA$LMA)))+coef(Nm.LMA.all.lmer14a.a1)$Species[8,1]),
         log10(max(na.omit(PSCA$LMA))),c(Nm.LMA.slope.non*log10(max(na.omit(PSCA$LMA)))+coef(Nm.LMA.all.lmer14a.a1)$Species[8,1]),
         col="darkgreen",lty=2)
segments(log10(min(PSME$LMA)),c(Nm.LMA.slope.non*log10(min(PSME$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[9,1]),
         log10(max(PSME$LMA)),c(Nm.LMA.slope.non*log10(max(PSME$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[9,1]),
         col="cornflowerblue",lty=2)
segments(log10(min(ACKO$LMA)),c(Nm.LMA.slope.fix*log10(min(ACKO$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[1,1]+coef(Nm.LMA.all.lmer14a.a1)$Species[1,3]),
         log10(max(ACKO$LMA)),c(Nm.LMA.slope.fix*log10(max(ACKO$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[1,1]+coef(Nm.LMA.all.lmer14a.a1)$Species[1,3]),
         col="green3",lty=1)
segments(log10(min(ALRU$LMA)),c(Nm.LMA.slope.fix*log10(min(ALRU$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[2,1]+coef(Nm.LMA.all.lmer14a.a1)$Species[2,3]),
         log10(max(ALRU$LMA)),c(Nm.LMA.slope.fix*log10(max(ALRU$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[2,1]+coef(Nm.LMA.all.lmer14a.a1)$Species[2,3]),
         col="cyan",lty=1)
segments(log10(min(CAEQ$LMA)),c(Nm.LMA.slope.fix*log10(min(CAEQ$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[4,1]+coef(Nm.LMA.all.lmer14a.a1)$Species[4,3]),
         log10(max(CAEQ$LMA)),c(Nm.LMA.slope.fix*log10(max(CAEQ$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[4,1]+coef(Nm.LMA.all.lmer14a.a1)$Species[4,3]),
         col="darkorchid1",lty=1)
segments(log10(min(GLSE$LMA)),c(Nm.LMA.slope.fix*log10(min(GLSE$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[6,1]+coef(Nm.LMA.all.lmer14a.a1)$Species[6,3]),
         log10(max(GLSE$LMA)),c(Nm.LMA.slope.fix*log10(max(GLSE$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[6,1]+coef(Nm.LMA.all.lmer14a.a1)$Species[6,3]),
         col="darkgreen",lty=1)
segments(log10(min(MOFA$LMA)),c(Nm.LMA.slope.fix*log10(min(MOFA$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[7,1]+coef(Nm.LMA.all.lmer14a.a1)$Species[7,3]),
         log10(max(MOFA$LMA)),c(Nm.LMA.slope.fix*log10(max(MOFA$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[7,1]+coef(Nm.LMA.all.lmer14a.a1)$Species[7,3]),
         col="darkgoldenrod1",lty=1)
segments(log10(min(ROPS$LMA)),c(Nm.LMA.slope.fix*log10(min(ROPS$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[10,1]+coef(Nm.LMA.all.lmer14a.a1)$Species[10,3]),
         log10(max(ROPS$LMA)),c(Nm.LMA.slope.fix*log10(max(ROPS$LMA))+coef(Nm.LMA.all.lmer14a.a1)$Species[10,1]+coef(Nm.LMA.all.lmer14a.a1)$Species[10,3]),
         col="cornflowerblue",lty=1)
...
segments(log10(min(na.omit(BENI.NLIM$LMA))),c(Nm.LMA.slope.non*log10(min(na.omit(BENI.NLIM$LMA)))+Nm.LMA.int.non.NLIM),
         log10(max(na.omit(BENI.NLIM$LMA))),c(Nm.LMA.slope.non*log10(max(na.omit(BENI.NLIM$LMA)))+Nm.LMA.int.non.NLIM),lwd=3,lty=4,col="black")
mtext(text="b",side=3,cex=1,adj=0)
...
Na.LMA.slope.non<-summary(Na.LMA.all.lmer14.a2)$coefficients[2,1]
Na.LMA.slope.fix<-summary(Na.LMA.all.lmer14.a2)$coefficients[2,1]+summary(Na.LMA.all.lmer14.a2)$coefficients[5,1]
Na.LMA.int.fix<-summary(Na.LMA.all.lmer14.a2)$coefficients[1,1]+summary(Na.LMA.all.lmer14.a2)$coefficients[3,1]
Na.LMA.int.non<-summary(Na.LMA.all.lmer14.a2)$coefficients[1,1]
Na.LMA.slope.non.NLIM<-summary(Na.LMA.all.lmer14.a2)$coefficients[2,1]+summary(Na.LMA.all.lmer14.a2)$coefficients[6,1]
Na.LMA.int.non.NLIM<-summary(Na.LMA.all.lmer14.a2)$coefficients[1,1]+summary(Na.LMA.all.lmer14.a2)$coefficients[4,1]
...
Nm.LMA.slope.non<-summary(Nm.LMA.all.lmer14.a2)$coefficients[2,1]
Nm.LMA.slope.fix<-summary(Nm.LMA.all.lmer14.a2)$coefficients[2,1]+summary(Nm.LMA.all.lmer14.a2)$coefficients[5,1]
Nm.LMA.int.fix<-summary(Nm.LMA.all.lmer14.a2)$coefficients[1,1]+summary(Nm.LMA.all.lmer14.a2)$coefficients[3,1]
Nm.LMA.int.non<-summary(Nm.LMA.all.lmer14.a2)$coefficients[1,1]
Nm.LMA.slope.non.NLIM<-summary(Nm.LMA.all.lmer14.a2)$coefficients[2,1]+summary(Nm.LMA.all.lmer14.a2)$coefficients[6,1]
Nm.LMA.int.non.NLIM<-summary(Nm.LMA.all.lmer14.a2)$coefficients[1,1]+summary(Nm.LMA.all.lmer14.a2)$coefficients[4,1]
...
points(log10(gN_m.2)~log10(LMA),dat=MOFA,col="darkgoldenrod1",pch=16)
points(log10(gN_m.2)~log10(LMA),dat=ROPS,col="cornflowerblue",pch=16)
segments(log10(min(BENI.NSAT$LMA)),c(Na.LMA.slope.non*log10(min(BENI.NSAT$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[3,1]),
         log10(max(BENI.NSAT$LMA)),c(Na.LMA.slope.non*log10(max(BENI.NSAT$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[3,1]),
         col="green3",lty=2)
segments(log10(min(BENI.NLIM$LMA)),c(Na.LMA.slope.non.NLIM*log10(min(BENI.NLIM$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[3,1]+coef(Na.LMA.all.lmer14.a2)$Species[3,4]),
         log10(max(BENI.NLIM$LMA)),c(Na.LMA.slope.non.NLIM*log10(max(BENI.NLIM$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[3,1]+coef(Na.LMA.all.lmer14.a2)$Species[3,4]),
         col="green3",lty=4)
segments(log10(min(DOVI.NSAT$LMA)),c(Na.LMA.slope.non*log10(min(DOVI.NSAT$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[5,1]),
         log10(max(DOVI.NSAT$LMA)),c(Na.LMA.slope.non*log10(max(DOVI.NSAT$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[5,1]),
         col="darkgoldenrod1",lty=2)
segments(log10(min(DOVI.NLIM$LMA)),c(Na.LMA.slope.non.NLIM*log10(min(DOVI.NLIM$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[5,1]+coef(Na.LMA.all.lmer14.a2)$Species[5,4]),
         log10(max(DOVI.NLIM$LMA)),c(Na.LMA.slope.non.NLIM*log10(max(DOVI.NLIM$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[5,1]+coef(Na.LMA.all.lmer14.a2)$Species[5,4]),
         col="darkgoldenrod1",lty=4)
segments(log10(min(na.omit(PSCA.NSAT$LMA))),c(Na.LMA.slope.non*log10(min(na.omit(PSCA.NSAT$LMA)))+coef(Na.LMA.all.lmer14.a2)$Species[8,1]),
         log10(max(na.omit(PSCA.NSAT$LMA))),c(Na.LMA.slope.non*log10(max(na.omit(PSCA.NSAT$LMA)))+coef(Na.LMA.all.lmer14.a2)$Species[8,1]),
         col="darkgreen",lty=2)
segments(log10(min(na.omit(PSCA.NLIM$LMA))),c(Na.LMA.slope.non.NLIM*log10(min(na.omit(PSCA.NLIM$LMA)))+coef(Na.LMA.all.lmer14.a2)$Species[8,1]+coef(Na.LMA.all.lmer14.a2)$Species[8,4]),
         log10(max(na.omit(PSCA.NLIM$LMA))),c(Na.LMA.slope.non.NLIM*log10(max(na.omit(PSCA.NLIM$LMA)))+coef(Na.LMA.all.lmer14.a2)$Species[8,1]+coef(Na.LMA.all.lmer14.a2)$Species[8,4]),
         col="darkgreen",lty=4)
segments(log10(min(PSME$LMA)),c(Na.LMA.slope.non*log10(min(PSME$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[9,1]),
         log10(max(PSME$LMA)),c(Na.LMA.slope.non*log10(max(PSME$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[9,1]),
         col="cornflowerblue",lty=2)
segments(log10(min(ACKO$LMA)),c((Na.LMA.slope.non+coef(Na.LMA.all.lmer14.a2)$Species[1,5])*log10(min(ACKO$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[1,1]+coef(Na.LMA.all.lmer14.a2)$Species[1,3]),
         log10(max(ACKO$LMA)),c((Na.LMA.slope.non+coef(Na.LMA.all.lmer14.a2)$Species[1,5])*log10(max(ACKO$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[1,1]+coef(Na.LMA.all.lmer14.a2)$Species[1,3]),
         col="green3",lty=1)
segments(log10(min(ALRU$LMA)),c((Na.LMA.slope.non+coef(Na.LMA.all.lmer14.a2)$Species[2,5])*log10(min(ALRU$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[2,1]+coef(Na.LMA.all.lmer14.a2)$Species[2,3]),
         log10(max(ALRU$LMA)),c((Na.LMA.slope.non+coef(Na.LMA.all.lmer14.a2)$Species[2,5])*log10(max(ALRU$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[2,1]+coef(Na.LMA.all.lmer14.a2)$Species[2,3]),
         col="cyan",lty=1)
segments(log10(min(CAEQ$LMA)),c(Na.LMA.slope.fix*log10(min(CAEQ$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[4,1]+coef(Na.LMA.all.lmer14.a2)$Species[4,3]),
         log10(max(CAEQ$LMA)),c(Na.LMA.slope.fix*log10(max(CAEQ$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[4,1]+coef(Na.LMA.all.lmer14.a2)$Species[4,3]),
         col="darkorchid1",lty=1)
segments(log10(min(GLSE$LMA)),c(Na.LMA.slope.fix*log10(min(GLSE$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[6,1]+coef(Na.LMA.all.lmer14.a2)$Species[6,3]),
         log10(max(GLSE$LMA)),c(Na.LMA.slope.fix*log10(max(GLSE$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[6,1]+coef(Na.LMA.all.lmer14.a2)$Species[6,3]),
         col="darkgreen",lty=1)
segments(log10(min(MOFA$LMA)),c(Na.LMA.slope.fix*log10(min(MOFA$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[7,1]+coef(Na.LMA.all.lmer14.a2)$Species[7,3]),
         log10(max(MOFA$LMA)),c(Na.LMA.slope.fix*log10(max(MOFA$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[7,1]+coef(Na.LMA.all.lmer14.a2)$Species[7,3]),
         col="darkgoldenrod1",lty=1)
segments(log10(min(ROPS$LMA)),c(Na.LMA.slope.fix*log10(min(ROPS$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[10,1]+coef(Na.LMA.all.lmer14.a2)$Species[10,3]),
         log10(max(ROPS$LMA)),c(Na.LMA.slope.fix*log10(max(ROPS$LMA))+coef(Na.LMA.all.lmer14.a2)$Species[10,1]+coef(Na.LMA.all.lmer14.a2)$Species[10,3]),
         col="cornflowerblue",lty=1)
axis(2,at=c(log10(0.5),log10(1),log10(2),log10(3),log10(4),log10(5),log10(6),log10(7)),labels=c(0.5,1,2,3,4,5,6,7),las=1)
axis(1,at=c(log10(c(20,30,40,50,100,200,300,400,500))),labels=c(20,30,40,50,100,200,300,400,500))
axis(1,at=c(log10(seq(10, 500, length.out = 50))),labels=NA,las=1)
...
points(log10(X.N_mass)~log10(LMA),dat=MOFA,col="darkgoldenrod1",pch=16)
points(log10(X.N_mass)~log10(LMA),dat=ROPS,col="cornflowerblue",pch=16)
segments(log10(min(BENI.NSAT$LMA)),c(Nm.LMA.slope.non*log10(min(BENI.NSAT$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[3,1]),
         log10(max(BENI.NSAT$LMA)),c(Nm.LMA.slope.non*log10(max(BENI.NSAT$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[3,1]),
         col="green3",lty=2)
segments(log10(min(BENI.NLIM$LMA)),c(Nm.LMA.slope.non.NLIM*log10(min(BENI.NLIM$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[3,1]+coef(Nm.LMA.all.lmer14.a2)$Species[3,4]),
         log10(max(BENI.NLIM$LMA)),c(Nm.LMA.slope.non.NLIM*log10(max(BENI.NLIM$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[3,1]+coef(Nm.LMA.all.lmer14.a2)$Species[3,4]),
         col="green3",lty=4)
segments(log10(min(DOVI.NSAT$LMA)),c(Nm.LMA.slope.non*log10(min(DOVI.NSAT$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[5,1]),
         log10(max(DOVI.NSAT$LMA)),c(Nm.LMA.slope.non*log10(max(DOVI.NSAT$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[5,1]),
         col="darkgoldenrod1",lty=2)
segments(log10(min(DOVI.NLIM$LMA)),c(Nm.LMA.slope.non.NLIM*log10(min(DOVI.NLIM$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[5,1]+coef(Nm.LMA.all.lmer14.a2)$Species[5,4]),
         log10(max(DOVI.NLIM$LMA)),c(Nm.LMA.slope.non.NLIM*log10(max(DOVI.NLIM$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[5,1]+coef(Nm.LMA.all.lmer14.a2)$Species[5,4]),
         col="darkgoldenrod1",lty=4)
segments(log10(min(na.omit(PSCA.NSAT$LMA))),c(Nm.LMA.slope.non*log10(min(na.omit(PSCA.NSAT$LMA)))+coef(Nm.LMA.all.lmer14.a2)$Species[8,1]),
         log10(max(na.omit(PSCA.NSAT$LMA))),c(Nm.LMA.slope.non*log10(max(na.omit(PSCA.NSAT$LMA)))+coef(Nm.LMA.all.lmer14.a2)$Species[8,1]),
         col="darkgreen",lty=2)
segments(log10(min(na.omit(PSCA.NLIM$LMA))),c(Nm.LMA.slope.non.NLIM*log10(min(na.omit(PSCA.NLIM$LMA)))+coef(Nm.LMA.all.lmer14.a2)$Species[8,1]+coef(Nm.LMA.all.lmer14.a2)$Species[8,4]),
         log10(max(na.omit(PSCA.NLIM$LMA))),c(Nm.LMA.slope.non.NLIM*log10(max(na.omit(PSCA.NLIM$LMA)))+coef(Nm.LMA.all.lmer14.a2)$Species[8,1]+coef(Nm.LMA.all.lmer14.a2)$Species[8,4]),
         col="darkgreen",lty=4)
segments(log10(min(PSME$LMA)),c(Nm.LMA.slope.non*log10(min(PSME$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[9,1]),
         log10(max(PSME$LMA)),c(Nm.LMA.slope.non*log10(max(PSME$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[9,1]),
         col="cornflowerblue",lty=2)
segments(log10(min(ACKO$LMA)),c(Nm.LMA.slope.fix*log10(min(ACKO$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[1,1]+coef(Nm.LMA.all.lmer14.a2)$Species[1,3]),
         log10(max(ACKO$LMA)),c(Nm.LMA.slope.fix*log10(max(ACKO$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[1,1]+coef(Nm.LMA.all.lmer14.a2)$Species[1,3]),
         col="green3",lty=1)
segments(log10(min(ALRU$LMA)),c(Nm.LMA.slope.fix*log10(min(ALRU$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[2,1]+coef(Nm.LMA.all.lmer14.a2)$Species[2,3]),
         log10(max(ALRU$LMA)),c(Nm.LMA.slope.fix*log10(max(ALRU$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[2,1]+coef(Nm.LMA.all.lmer14.a2)$Species[2,3]),
         col="cyan",lty=1)
segments(log10(min(CAEQ$LMA)),c(Nm.LMA.slope.fix*log10(min(CAEQ$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[4,1]+coef(Nm.LMA.all.lmer14.a2)$Species[4,3]),
         log10(max(CAEQ$LMA)),c(Nm.LMA.slope.fix*log10(max(CAEQ$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[4,1]+coef(Nm.LMA.all.lmer14.a2)$Species[4,3]),
         col="darkorchid1",lty=1)
segments(log10(min(GLSE$LMA)),c(Nm.LMA.slope.fix*log10(min(GLSE$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[6,1]+coef(Nm.LMA.all.lmer14.a2)$Species[6,3]),
         log10(max(GLSE$LMA)),c(Nm.LMA.slope.fix*log10(max(GLSE$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[6,1]+coef(Nm.LMA.all.lmer14.a2)$Species[6,3]),
         col="darkgreen",lty=1)
segments(log10(min(MOFA$LMA)),c(Nm.LMA.slope.fix*log10(min(MOFA$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[7,1]+coef(Nm.LMA.all.lmer14.a2)$Species[7,3]),
         log10(max(MOFA$LMA)),c(Nm.LMA.slope.fix*log10(max(MOFA$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[7,1]+coef(Nm.LMA.all.lmer14.a2)$Species[7,3]),
         col="darkgoldenrod1",lty=1)
segments(log10(min(ROPS$LMA)),c(Nm.LMA.slope.fix*log10(min(ROPS$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[10,1]+coef(Nm.LMA.all.lmer14.a2)$Species[10,3]),
         log10(max(ROPS$LMA)),c(Nm.LMA.slope.fix*log10(max(ROPS$LMA))+coef(Nm.LMA.all.lmer14.a2)$Species[10,1]+coef(Nm.LMA.all.lmer14.a2)$Species[10,3]),
         col="cornflowerblue",lty=1)
axis(2,at=c(log10(0.5),log10(1),log10(2),log10(3),log10(4),log10(5),log10(6)),labels=c(0.5,1,2,3,4,5,6),las=1)
axis(1,at=c(log10(c(20,30,40,50,100,200,300,400,500))),labels=c(20,30,40,50,100,200,300,400,500))
axis(1,at=c(log10(seq(10, 500, length.out = 50))),labels=NA,las=1)
